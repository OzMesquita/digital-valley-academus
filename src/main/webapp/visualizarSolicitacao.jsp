															...
															<div class="card-body">
																<div class="form-row">
															        <%if(disCursada.getEmenta().getIdArquivo() > 0){ %>
															        	<input type="checkbox" name="webmaster" value="ementa"/><%=disCursada.getEmenta().getNome()%><br/>
															        <%}else{%>
															...
															<div class="card-body">
																<div class="form-row">
															        <%if(disCursada.getHistorico().getIdArquivo() > 0){ %>
															        	<input type="checkbox" name="webmaster" value="historico"/><%=disCursada.getHistorico().getNome()%><br/>
															        <%}else{%>
					    												Nenhum arquivo anexado
																	<%}%>
																	<br>
