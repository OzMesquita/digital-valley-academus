			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<table class="table" id="listaCursos">
						...
						<%for(Curso c : lc){
							Professor prof = pd.isCoordenador(c.getIdCurso());
							%>
							<tr>
								<td><%=c.getNome()%></td>
								<td>
								...
								<div class="form-row">
									<div class="form-group-col-md-9">
										<select name="cursoInput-<%=c.getIdCurso()%>" class="form-control">
											<option id="professorOption-default" selected="selected" value="<%=!prof.equals(null) ? prof.getId() : -1%>"><%=prof.getId() > 0 ? prof.getNome() : "Sem Coordenador"%></option>
											<%for(Professor p : lp){ %>
